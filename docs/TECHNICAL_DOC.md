...
on one. Our backtest over 27 real World Cup matches (~1.4M TxLINE odds rows) shows
why acting matters: the average lockable P/L of a position opened at a spike
turns negative within 60 seconds and keeps decaying. All figures — sample
